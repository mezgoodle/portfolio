...
export const metadata: Metadata = {
  title: "About - Mezgoodle",
  description:
    "Learn more about Maksym (mezgoodle): journey, principles, and how to get in touch.",
  alternates: {
    canonical: "/about",
  },
};
      ...
      <div className="container mx-auto px-4 py-16">
        <section className="text-center mb-24">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            effective solutions to complex problems. My goal is to write code
            that not only works, but also inspires and pushes people forward (or
            at least me).
          </p>
        </section>
